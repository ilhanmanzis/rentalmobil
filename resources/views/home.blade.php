            ...
            <div class="hero-content flex-col lg:flex-row-reverse">
                ...
                <div>
                    ...
                    <p class="py-6">
                        ...
                        di Yogyakarta,
                        menawarkan layanan
                        rental mobil dan motor yang lengkap serta paket wisata menarik untuk menjelajahi keindahan
                        kota dan sekitarnya. Kami menyediakan armada kendaraan yang terawat dengan baik dan driver
                        profesional yang siap menemani perjalanan Anda dengan aman dan nyaman.
                    </p>
            ...
            <div class="py-5 flex justify-start">
                <a href="#"><!-- Whatsapp -->
                    <span class="[&>svg]:h-7 [&>svg]:w-7 [&>svg]:fill-[#128c7e] flex justify-start">
                        ...
                        <small class="text-lg px-2">+629798798789</small>
                    </span>
                </a>
            </div>
