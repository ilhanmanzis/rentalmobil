    ...
    <div class="hero-content text-white" style="z-index: 2;">
        <div class="lg:mx-10 mx-5">
            ...
            <a href="{{ url('/') }}/kendaraan"
                class="btn bg-sky-600 border-none text-white hover:bg-sky-400 mr-5">Pilih Kendaraan
                Sekarang
            ...
            <a href="{{ url('/') }}/wisata"
                class="btn bg-sky-600 border-none text-white hover:bg-sky-400 mt-4">Paket Wisata
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                    stroke="currentColor" class="size-6">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 8.25 21 12m0 0-3.75 3.75M21 12H3" />
                </svg>
