<x-admin.layout>
    ...
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        <div class="flex flex-col gap-10">
            <a href="{{ url('/admin/wisata/create') }}" class="btn btn-info w-40 text-white">Tambah data</a>
            <!-- ====== Table One Start -->
            <div
                        ...
                        <div class="card w-72 shadow-xl my-5 lg:mx-6 mx-0">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-actions justify-end mt-2">
                                    <a href="{{ url('/') }}/admin/wisata/edit/{{ $wisata['id_wisata'] }}"
                                    ...
                                    <form action="{{ route('wisata.delete', ['id' => $wisata['id_wisata']]) }}"
