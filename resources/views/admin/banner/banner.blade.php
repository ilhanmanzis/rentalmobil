<x-admin.layout>
    ...
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        <div class="flex flex-col gap-10">
            <!-- ====== Table One Start -->
            <a href="{{ url('/admin/banner/create') }}" class="btn btn-info w-40 text-white">Tambah data</a>
            <div
                    ...
                    @foreach ($banners as $banner)
                        <tr class="border-b border-stroke dark:border-strokedark">
                            ...
                            <td class="text-center font-medium text-black dark:text-white py-3">
                                <a href="{{ url('/') }}/admin/banner/edit/{{ $banner['id_banner'] }}"
                                    ...
                                    <svg class="w-8 fill-white" viewBox="0 0 448 512"
                                        xmlns="http://www.w3.org/2000/svg">
                                ...
                                <form action="{{ route('banner.delete', ['id' => $banner['id_banner']]) }}"
                                    class="flex justify-center"
                                    onsubmit="return confirm('Apakah anda yakin ingin menghapus data?')" method="POST">
                                    @csrf
                                    @method('delete')
                                    <div class="w-10 bg-red-700 rounded-md">
                                        <button type="submit"
