        ...
        <div class="flex flex-col gap-9">
            ...
            <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <div class="flex flex-col gap-5.5 p-6.5">
                    <form action="{{ route('mobil.edit', ['id' => $mobil['id_mobil']]) }}" method="POST"
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="...." name="nama" value="{{ $mobil['nama'] }}"
                        ...
                        <div>
                            ...
                            <input type="number" placeholder="..." name="harga_lepas"
                                value="{{ $mobil['harga_lepas'] }}"
                                class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" />
                            @error('harga_lepas')
                                <span class="text-sm text-red-600">{{ $message }}</span>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="time" placeholder="...." name="jam_mulai" value="{{ $mobil['jam_mulai'] }}"
                                class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" />
                            @error('jam_mulai')
                                <span class="text-sm text-red-600">{{ $message }}</span>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="...." name="pintu" value="{{ $mobil['pintu'] }}"
                                class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" />
                            @error('pintu')
                                <span class="text-sm text-red-600">{{ $message }}</span>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="...." name="penumpang" value="{{ $mobil['penumpang'] }}"
                                class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" />
                            @error('penumpang')
                                <span class="text-sm text-red-600">{{ $message }}</span>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="...." name="wilayah" value="{{ $mobil['wilayah'] }}"
                                class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" />
                            @error('wilayah')
                                <span class="text-sm text-red-600">{{ $message }}</span>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="...." name="include" value="{{ $mobil['include'] }}"
                                class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" />
                            @error('include')
                                <span class="text-sm text-red-600">{{ $message }}</span>
                            @enderror
                        ...
                        <!-- Tampilan Gambar -->
                        <div class="mb-3">
                            <img id="previewImage" src="{{ url('/') }}/images/mobil/{{ $mobil['foto'] }}"
