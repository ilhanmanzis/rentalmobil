...
use App\Http\Middleware\AuthRedirectDashboard;
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/admin/setting/profile', [SettingController::class, 'show'])->name('setting.akun');
    Route::put('/admin/setting/profile/edit/{id}', [SettingController::class, 'updateProfile'])->name('setting.edit.profile');
    Route::put('/admin/setting/profile/password/{id}', [SettingController::class, 'updatePassword'])->name('setting.edit.password');

    //logout
    Route::get('/logout', [AuthController::class, 'destroy'])->name('logout');
});

Route::middleware([AuthRedirectDashboard::class])->group(function () {
